...
const ONBOARD_QUESTIONS = [
  ...
  { q: "Oggi lavori, studi, o entrambi?", a: "Capire la tua situazione attuale aiuta a costruire un piano realistico." },
  { q: "Hai competenze, titoli di studio o certificazioni che vuoi che io conosca?", a: "Le terrò a mente come risorse su cui costruire." },
...
/* ====================== APP ROOT ====================== */
// Contatore gratuito senza backend (counterapi.dev): conta visite e onboarding completati.
// Per vedere i numeri basta aprire questi due link da browser:
// https://api.counterapi.dev/v1/lifepath-app/visite
// https://api.counterapi.dev/v1/lifepath-app/onboarding-completati
function trackEvent(name) {
  fetch(`https://api.counterapi.dev/v1/lifepath-app/${name}/up`).catch(() => {});
}
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: t.bg, transition: "background .3s ease" }}>
      {!onboarded ? (
        <Onboarding t={t} onDone={() => { trackEvent("onboarding-completati"); setOnboarded(true); }} />
      ) : (
        <>
